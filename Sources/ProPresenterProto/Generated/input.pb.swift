...
public struct Rv_Data_VideoInput: @unchecked Sendable {
  ...
  public var videoInputDevice: Rv_Data_Media.VideoDevice {
    get {return _storage._videoInputDevice ?? Rv_Data_Media.VideoDevice()}
    set {_uniqueStorage()._videoInputDevice = newValue}
  }
  /// Returns true if `videoInputDevice` has been explicitly set.
  public var hasVideoInputDevice: Bool {return _storage._videoInputDevice != nil}
  ...
  public var displayColor: Rv_Data_Color {
    get {return _storage._displayColor ?? Rv_Data_Color()}
    set {_uniqueStorage()._displayColor = newValue}
  }
  /// Returns true if `displayColor` has been explicitly set.
  public var hasDisplayColor: Bool {return _storage._displayColor != nil}
  ...
  public var thumbnailPath: Rv_Data_URL {
    get {return _storage._thumbnailPath ?? Rv_Data_URL()}
    set {_uniqueStorage()._thumbnailPath = newValue}
  }
  /// Returns true if `thumbnailPath` has been explicitly set.
  public var hasThumbnailPath: Bool {return _storage._thumbnailPath != nil}
...
public struct Rv_Data_AudioInput: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var source: Rv_Data_AudioInput.OneOf_Source? = nil
...
extension Rv_Data_VideoInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}uuid\0\u{3}user_description\0\u{3}video_input_device\0\u{3}display_color\0\u{3}thumbnail_path\0\u{3}audio_device\0\u{3}video_device\0\u{3}audio_type\0")
