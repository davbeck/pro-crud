...
public struct Rv_Data_Timer: Sendable {
  ...
  public struct Format: Sendable {
    ...
    public var hour: Rv_Data_Timer.Format.Style = .styeNone

    public var minute: Rv_Data_Timer.Format.Style = .styeNone

    public var second: Rv_Data_Timer.Format.Style = .styeNone

    public var millisecond: Rv_Data_Timer.Format.Style = .styeNone
...
public struct Rv_Data_TimersDocument: Sendable {
  ...
  public var clock: Rv_Data_Clock {
    get {return _clock ?? Rv_Data_Clock()}
    set {_clock = newValue}
  }
  /// Returns true if `clock` has been explicitly set.
  public var hasClock: Bool {return self._clock != nil}
...
extension Rv_Data_Timer.Format.Style: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0STYE_NONE\0\u{1}STYLE_SHORT\0\u{1}STYLE_LONG\0\u{1}STYLE_REMOVE_SHORT\0\u{1}STYLE_REMOVE_LONG\0")
}
