...
public struct Rv_Data_Recording: Sendable {
  ...
  public struct Stream: Sendable {
    ...
    public var encoder: Rv_Data_Recording.Stream.Encoder {
      get {return _encoder ?? Rv_Data_Recording.Stream.Encoder()}
      set {_encoder = newValue}
    }
    /// Returns true if `encoder` has been explicitly set.
    public var hasEncoder: Bool {return self._encoder != nil}
    ...
    public struct Encoder: Sendable {
      ...
      public var codec: Rv_Data_Recording.Stream.Encoder.Codec = .automatic
      ...
      public var frameRate: Rv_Data_Recording.Stream.Encoder.FrameRate = .unknown
      ...
      public enum Codec: SwiftProtobuf.Enum, Swift.CaseIterable {
        ...
        public static let allCases: [Rv_Data_Recording.Stream.Encoder.Codec] = [
          .automatic,
          .h264,
          .h265,
          .prores422Proxy,
      ...
      public enum FrameRate: SwiftProtobuf.Enum, Swift.CaseIterable {
        ...
        // The compiler won't synthesize support with the UNRECOGNIZED case.
        public static let allCases: [Rv_Data_Recording.Stream.Encoder.FrameRate] = [
          .unknown,
          .frameRate24,
          .frameRate25,
          .frameRate2997,
    ...
    public struct DiskDestination: Sendable {
      ...
      public var location: Rv_Data_URL {
        get {return _location ?? Rv_Data_URL()}
      ...
      public var container: Rv_Data_Recording.Stream.DiskDestination.Container = .unknown
      ...
      public enum Container: SwiftProtobuf.Enum, Swift.CaseIterable {
        ...
        // The compiler won't synthesize support with the UNRECOGNIZED case.
        public static let allCases: [Rv_Data_Recording.Stream.DiskDestination.Container] = [
          .unknown,
          .mov,
          .mp4,
        ]
    ...
    public struct Destination: Sendable {
      ...
      public struct Resi: Sendable {
        ...
        public var destinationGroupID: Rv_Data_UUID {
          get {return _destinationGroupID ?? Rv_Data_UUID()}
          set {_destinationGroupID = newValue}
        }
        /// Returns true if `destinationGroupID` has been explicitly set.
        public var hasDestinationGroupID: Bool {return self._destinationGroupID != nil}
        ...
        public var encoderProfileID: Rv_Data_UUID {
          get {return _encoderProfileID ?? Rv_Data_UUID()}
          set {_encoderProfileID = newValue}
        }
        /// Returns true if `encoderProfileID` has been explicitly set.
        public var hasEncoderProfileID: Bool {return self._encoderProfileID != nil}
...
extension Rv_Data_Recording.Stream.Encoder: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}codec\0\u{3}video_width\0\u{3}video_height\0\u{3}is_interlaced\0\u{1}frameRate\0\u{3}video_bitrate\0")
...
extension Rv_Data_Recording.Stream.Encoder.Codec: SwiftProtobuf._ProtoNameProviding {
...
extension Rv_Data_Recording.Stream.Encoder.FrameRate: SwiftProtobuf._ProtoNameProviding {
...
extension Rv_Data_Recording.Stream.DiskDestination.Container: SwiftProtobuf._ProtoNameProviding {
